...
def creat_directory_line(line,headline_mark,i):
    if headline_mark == '#':
        ...
        return '&emsp;' + line[3:-1] + "  \n"
    elif headline_mark == '###':
        return '&emsp;&emsp;' + line[4:-1] + "  \n"
    elif headline_mark == '####':
        return '&emsp;&emsp;&emsp;' + line[5:-1] + "  \n"
    elif headline_mark == '#####':
        return '&emsp;&emsp;&emsp;&emsp;' + line[6:-1] + "  \n"
    elif headline_mark == '######':
        return '&emsp;&emsp;&emsp;&emsp;&emsp;' + line[7:-1] + "  \n"
