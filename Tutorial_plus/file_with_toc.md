...
确保以hadoop用户执行  
格式化namenode  
&emsp;2. HDFS的部署(云服务器)<big>  
&emsp;&emsp;AWS EMR  
注意：下面所有code应该写在同一行内  
&emsp;3. HDFS基本操作  
&emsp;&emsp;1. HDFS集群启停操作<big>  
&emsp;&emsp;2. HDFS文件系统  
&emsp;&emsp;&emsp;1.HDFS文件系统构成  
&emsp;&emsp;&emsp;2. HDFS文件系统操作  
&emsp;&emsp;&emsp;4. HDFS文件系统权限  
&emsp;&emsp;&emsp;*5. 使用pycharm插件Big Data Tools连接HDFS  
&emsp;&emsp;&emsp;6. HDFS文件储存原理  
fsck可以检查指定路径是否正常  
&emsp;&emsp;3. HDFS文件系统的读写原理  
&emsp;&emsp;&emsp;1. 数据写入  
&emsp;&emsp;&emsp;2. 数据读取  
2. Yarn  
&emsp;1. Yarn的作用  
&emsp;2. Yarn的架构  
&emsp;&emsp;1. 核心架构-ReourceManager+NodeManager  
&emsp;&emsp;2. 辅助架构-ProxysServer+JobHistoryServer  
&emsp;3. MapReduce & Yarn的部署  
&emsp;&emsp;1. MapReduce的配置  
&emsp;&emsp;2. Yarn的配置  
&emsp;4. Yarn的启动  
&emsp;5. 提交MapReduce任务到Yarn运行  
&emsp;&emsp;MapReduce示例程序  
MapReduce实例演示  
&emsp;项目实例1：wordcount  
下载数据  
mapper.py  
reducer.py  
...
注意：下面所有code应该写在同一行内  
&emsp;项目实例2：使用MR内置函数  
&emsp;&emsp;1.wordcount 示例  
&emsp;&emsp;2.MC方法求PI 示例  
# <a name="0"><big>Hadoop</big></a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >

- [Hadoop](#hadoop)
  - [1. HDFS](#1-hdfs)
    - [1.1 HDFS的部署(本地虚拟机)](#11-hdfs的部署本地虚拟机)
    - [1.2 HDFS的部署(云服务器)](#12-hdfs的部署云服务器)
      - [AWS EMR](#aws-emr)
    - [1.3 HDFS基本操作](#13-hdfs基本操作)
      - [HDFS集群启停操作](#hdfs集群启停操作)
      - [HDFS文件系统](#hdfs文件系统)
        - [HDFS文件系统构成](#hdfs文件系统构成)
        - [HDFS文件系统操作](#hdfs文件系统操作)
        - [HDFS文件系统权限](#hdfs文件系统权限)
        - [使用pycharm插件Big Data Tools连接HDFS](#使用pycharm插件big-data-tools连接hdfs)
        - [HDFS文件储存原理](#hdfs文件储存原理)
      - [HDFS文件系统的读写原理](#hdfs文件系统的读写原理)
  - [2. Yarn](#2-yarn)
    - [Yarn的作用](#yarn的作用)
    - [Yarn的架构](#yarn的架构)
      - [核心架构-ReourceManager+NodeManager](#核心架构-reourcemanagernodemanager)
      - [辅助架构-ProxysServer+JobHistoryServer](#辅助架构-proxysserverjobhistoryserver)
    - [MapReduce & Yarn的部署](#mapreduce--yarn的部署)
    - [Yarn的启动](#yarn的启动)
    - [提交MapReduce任务到Yarn运行](#提交mapreduce任务到yarn运行)
  - [MapReduce实例演示](#mapreduce实例演示)
    - [项目实例1：wordcount](#项目实例1wordcount)
    - [项目实例2：MR内置程序](#项目实例2mr内置程序)




# <a name="1">1. HDFS</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
## <a name="2">1. HDFS的部署(本地虚拟机)</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
vim workers
# <a name="3">填入以下内容</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
node1
node2
node3
```
...
```
# <a name="4">填入以下内容</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
```
cd /export/server
# <a name="5">注意：scp命令只能复制原文件到其他node，不可以复制软连接（看作快捷方式）</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
cd /export/server
vim /etc/profile
# <a name="6">在文件末尾添加以下内容</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
export HADOOP_HOME=/export/server/hadoop
export PATH=$PATH:$HADOOP_HOME/bin:$HADOOP_HOME/sbin
# <a name="7">保存退出，再生效环境变量</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
source /etc/profile
```
...
```
# <a name="8">chown表示修改文件的所有者，-R表示递归修改，语法：chown -R 用户名:用户组 文件名</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
```
# <a name="9">确保以hadoop用户执行</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
su - hadoop
# <a name="10">格式化namenode</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
## <a name="11">2. HDFS的部署(云服务器)<big></a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
### <a name="12">AWS EMR</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
```
# <a name="13">注意：下面所有code应该写在同一行内</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
## <a name="14">3. HDFS基本操作</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
### <a name="15">1. HDFS集群启停操作<big></a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
### <a name="16">2. HDFS文件系统</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
#### <a name="17">1.HDFS文件系统构成</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
#### <a name="18">2. HDFS文件系统操作</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
Hadoop提供了两套命令体系：
...
#### <a name="19">4. HDFS文件系统权限</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
#### <a name="20">*5. 使用pycharm插件Big Data Tools连接HDFS</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
#### <a name="21">6. HDFS文件储存原理</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
# <a name="22">fsck可以检查指定路径是否正常</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
-files可以列出路径内的文件状态
...
### <a name="23">3. HDFS文件系统的读写原理</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
#### <a name="24">1. 数据写入</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
#### <a name="25">2. 数据读取</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
# <a name="26">2. Yarn</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
## <a name="27">1. Yarn的作用</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
## <a name="28">2. Yarn的架构</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
### <a name="29">1. 核心架构-ReourceManager+NodeManager</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
### <a name="30">2. 辅助架构-ProxysServer+JobHistoryServer</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
1. Web ProxysServer
...
## <a name="31">3. MapReduce & Yarn的部署</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
### <a name="32">1. MapReduce的配置</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
### <a name="33">2. Yarn的配置</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
1.yarn-env.sh
```shell
#设置jdk路径
export JAVA_HOME=/export/server/jdk
...
```
## <a name="34">4. Yarn的启动</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
## <a name="35">5. 提交MapReduce任务到Yarn运行</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
Yarn本身作为资源调度框架，不负责任务的运行，但会提供资源供许多程序运行，如：\
MapReduce、Spark、Hive、HBase等，这些程序都可以运行在Yarn上。

### <a name="36">MapReduce示例程序</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
# <a name="37">MapReduce实例演示</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
## <a name="38">项目实例1：wordcount</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
step 1:准备需要count的txt文件数据，这里使用从一个网站直接下载。\
在node1：`/export/server/wordcount`下创建books-input文件夹，vim创建download_books.sh文件，写入以下内容：
```
#!/bin/bash
# <a name="39">下载数据</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
for i in {1000..1100}
do
...
```
# <a name="40">mapper.py</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
#!/usr/bin/env python
import sys
import string
...
```
```
# <a name="41">reducer.py</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
#!/usr/bin/env python3
...
```
# <a name="42">在hdfs的根目录`/`下创建wordcount文件夹，其中创建文件夹books-input；</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
# <a name="43">将本地books-input中的所有txt文件上传到hdfs的/wordcount/books-input文件夹下</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
```shell
# <a name="44">注意：下面所有code应该写在同一行内</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
## <a name="45">项目实例2：使用MR内置函数</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
### <a name="46">1.wordcount 示例</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
...
### <a name="47">2.MC方法求PI 示例</a ><a style="float:right;text-decoration:none;" href="#index">[Top]</a >
